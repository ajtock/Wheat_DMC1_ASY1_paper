...
# Use permutation test function in regioneR to determine if
# DMC1 ChIP-seq peaks overlap features of interest
# (e.g., peaks in other ChIP-seq data sets , genes, TEs)
# more or less than expected by chance

# Usage:
# /applications/R/R-3.3.2/bin/Rscript DMC1_peaks_overlap_permTests_otherFeatures.R DMC1_Rep1_ChIP 10000 'euchromatin' 'A'"
