...
# DMC1 ChIP-seq peaks overlap elements within each transposon superfamily
# more or less than expected by chance

# Usage:
# /applications/R/R-3.3.2/bin/Rscript DMC1_peaks_overlap_permTests_TEsuperfams.R DMC1_Rep1_ChIP 10000 'euchromatin' 'A'"
