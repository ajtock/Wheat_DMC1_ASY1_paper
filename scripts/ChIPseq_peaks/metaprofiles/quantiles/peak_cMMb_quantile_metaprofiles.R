...
# and SNP and transposon frequencies
...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript peak_cMMb_quantile_metaprofiles.R DMC1_Rep1_ChIP DMC1 'Agenome_euchromatin,Bgenome_euchromatin,Dgenome_euchromatin' cMMb 4 both 400 2000 2kb 20 '0.02,0.96'
