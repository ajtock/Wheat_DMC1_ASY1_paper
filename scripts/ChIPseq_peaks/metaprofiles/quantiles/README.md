...
`peak_cMMb_quantile_metaprofiles.R` calculates and plots metaprofiles of ChIP-seq signal, DNA methylation proportions and SNP and transposon frequencies (peak windowed means and 95% confidence intervals, CIs) for each group of peaks, defined either by decreasing recombination rate or randomly.
