...
# Extract peaks within given wheat subgenome compartments (a.k.a. partitions)
# E.g., "euchromatin" [R1 and R3 (distal)] or "heterochromatin" [R2 (interstitial) and C (proximal)]
# Order compartmentalized peaks by decreasing -log10(FDR)
# Define peak coordinates as peak summit-100 bp to peak summit+100 bp
# so that all peaks have a common width of 201 bp for weeder2 motif enrichment analysis
# Generate peak GFF3 and BED files (0-based start coordinates)

# Usage:
# ./5_sort_peaks_by_minuslog10Q_for_weeder2.R DMC1_Rep1_ChIP 'euchromatin' 'A'
...
# Function to determine rounded midpoints of GRanges loci and to include
# flanking bases (midpoint-leftFlank bases, midpoint, midpoint+rightFlank bases)
