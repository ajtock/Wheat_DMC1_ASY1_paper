ribokmers.fa.gz contains curated ribosomal sequences compiled primarily from the SILVA rRNA database by Brian Bushnell. Brian Bushnell's biostars post ( https://www.biostars.org/p/159959/ ) describes how to separate ribosomal sequences from non-ribosomal sequences using bbduk.sh:
