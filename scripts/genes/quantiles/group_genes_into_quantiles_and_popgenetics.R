...
# Load 811 exomes-derived SNP matrix from He et al. (2019) Nat. Genet. 51. DOI: 10.1038/s41588-019-0382-2
...
# Extend feature boundaries to include promoters and terminators for calculation of recombination rate (cM/Mb)
...
# Load and convert into GRanges previously calculated mean recombination rates
# in 10-Mb sliding windows with a 1-Mb step (iwgsc_refseqv1.0_recombination_rate.txt),
# available as part of the IWGSC RefSeq v1.0 annotation:
...
# Obtain cM/Mb values for each feature between promoter and terminator
# Where features overlap more than one window, calculate mean cM/Mb
...
# Calculate mean log2(ChIP/control) in
# gene promoters, bodies and terminators, and in all three combined ("genes")
...
# Obtain cM/Mb values for each ranLoc between promoter and terminator
# Where ranLocs overlap more than one window, calculate mean cM/Mb
