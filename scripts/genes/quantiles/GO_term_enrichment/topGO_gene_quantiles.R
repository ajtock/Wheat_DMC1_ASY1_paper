...
# gene ontology (GO) terms relative to their representation among
# all genes in the given subgenome(s).
# Use the default algorithm implemented in topGO ("weight01") to identify
# over-represented GO terms, with Fisher's exact test P-values <=sigLevel
...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript ./topGO_gene_quantiles.R BP 0.05 'DMC1_in_genes' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome'
