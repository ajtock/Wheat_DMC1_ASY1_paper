...
# Usage 
# ./proportion_homoeolog_expression_bias_categories_in_gene_quantiles_hypergeometricTest.R 'DMC1_Rep1_ChIP' 'genes' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome' 100000
...
# Triads.rds downloaded from the
