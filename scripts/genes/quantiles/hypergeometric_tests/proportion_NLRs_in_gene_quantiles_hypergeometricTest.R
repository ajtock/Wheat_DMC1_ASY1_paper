...
# NLR-encoding genes 
# (i.e., is the proportion of NLR-encoding genes
...
# Usage 
# ./proportion_NLRs_in_gene_quantiles_hypergeometricTest.R 'DMC1_Rep1_ChIP' 'genes' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome' 100000
