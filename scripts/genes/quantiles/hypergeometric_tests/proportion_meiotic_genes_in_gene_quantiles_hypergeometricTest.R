...
# meiotic genes (as defined in Alabdullah et al. 2019 Front. Plant Sci.)
# (i.e., is the proportion of meiotic genes
...
# Usage 
# ./proportion_meiotic_genes_in_gene_quantiles_hypergeometricTest.R 'DMC1_Rep1_ChIP' 'genes' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome' 100000
