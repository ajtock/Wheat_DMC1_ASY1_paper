...
# form part of a dynamic triad significantly greater or smaller than expected by chance
...
# Usage 
# ./proportion_stable_dynamic_triads_in_gene_quantiles_hypergeometricTest.R 'DMC1_Rep1_ChIP' 'genes' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome' 100000 6
...
# Triads.rds and TriadMovement.rds downloaded from the
# Earlham Institute Grassroots Data Repository on 8 April 2020, available at
# https://opendata.earlham.ac.uk/wheat/under_license/toronto/Ramirez-Gonzalez_etal_2018-06025-Transcriptome-Landscape/data/TablesForExploration
