...
# (LAR-overlapping genes) in each gene quantile 
# are over-represented or under-represented for
...
# Usage 
# ./proportion_overlapping_bioclim_among_local_adaptation_regions_in_gene_quantiles_hypergeometricTest.R 'DMC1_Rep1_ChIP' 'genes' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome' 100000
