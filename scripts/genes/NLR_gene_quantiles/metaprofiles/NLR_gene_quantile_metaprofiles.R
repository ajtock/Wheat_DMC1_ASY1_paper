...
# This script imports matrices of windowed values generated for all genes
# and selects the subset of rows corresponding to NLR genes

# Usage:
# /applications/R/R-3.5.0/bin/Rscript NLR_gene_quantile_metaprofiles.R cMMb both 'NLR_genes_in_Agenome_genomewide,NLR_genes_in_Bgenome_genomewide,NLR_genes_in_Dgenome_genomewide' 3500 2000 2kb '2 kb' 20 20bp genes 4 '0.02,0.96'
...
# Load all genes (which were used for generating the coverage matrices)
