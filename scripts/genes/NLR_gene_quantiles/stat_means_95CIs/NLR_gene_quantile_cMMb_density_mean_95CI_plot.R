...
# of recombination rate (cM/Mb) for each group of NLR genes

# Usage:
# /applications/R/R-3.5.0/bin/Rscript NLR_gene_quantile_cMMb_density_mean_95CI_plot.R cluster_members 'NLR_genes_in_Agenome_genomewide,NLR_genes_in_Bgenome_genomewide,NLR_genes_in_Dgenome_genomewide' genes 4
