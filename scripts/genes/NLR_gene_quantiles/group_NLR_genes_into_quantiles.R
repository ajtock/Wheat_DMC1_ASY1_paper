...
# Group NLR-encoding genes identified in Steuernagel et al. (2020) Plant Physiol. 183
# into groups corresponding to those in given percentile ranges with regard to, e.g., 
# mean recombination rate (cM/Mb), physical cluster size, or mean ChIP-seq signal
