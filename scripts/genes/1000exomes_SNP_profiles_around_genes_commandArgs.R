...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript ./1000exomes_SNP_profiles_around_genes_commandArgs.R genes_in_Agenome genomewide 3500 2000 2kb 20
...
# SNPs were annotated with their predicted impact on protein function using SnpEff v4.3t,
# after building a SnpEff database for the IWGSC RefSeq v1.0 Chinese Spring genome assembly with the RefSeq v1.1 gene annotation.
SNPs <- read.table("all.GP08_mm75_het3_publication01142019.ann.vcf",
                   header = F, skip = 31,
