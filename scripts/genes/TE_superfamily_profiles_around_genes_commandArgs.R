...
# Profile TE frequency around genes and random loci

# Usage: 
# /applications/R/R-3.4.0/bin/Rscript ./TE_superfamily_profiles_around_genes_commandArgs.R genes_in_Agenome genomewide 3500 2000 2kb 20
