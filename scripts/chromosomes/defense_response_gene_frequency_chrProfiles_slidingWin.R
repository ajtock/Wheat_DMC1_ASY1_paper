...
# Calculate "defense response" gene ontology (GO)-annotated gene
# frequency in sliding windows along each wheat chromosome

# Usage:
# ./defense_response_gene_frequency_chrProfiles_slidingWin.R 10Mb 10000000 1Mb 1000000
